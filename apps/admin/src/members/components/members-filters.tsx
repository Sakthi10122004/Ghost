...
const EMPTY_NEWSLETTERS: NonNullable<ReturnType<typeof useBrowseNewsletters>['data']>['newsletters'] = [];
...
const MembersFilters: React.FC<MembersFiltersProps> = ({
    ...
    const referencedCustomFieldKeys = useMemo(() => new Set(referencedCustomFieldNames), [referencedCustomFieldNames]);
