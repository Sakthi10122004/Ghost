...
import {RELATIVE_DATE_OPERATOR_LABELS, createOperatorOptions, createRelativeDateRenderer, fieldHasRelativeOperator, getTodayInTimezone, FIELD_ICONS} from '@/shared/filters';
    ...
    return useMemo(() => {
        function createFieldConfig(
            ...
            const parameterised = key.startsWith('newsletters.')
                ...
                : key.startsWith(CUSTOM_FIELDS_PREFIX) ? fields['custom_fields.:key'] : undefined;
