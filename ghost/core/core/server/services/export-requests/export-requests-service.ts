...
export class ExportRequestsService {
    ...
    async requestArchive({
        ...
        // Without a site id the host cannot attribute the archive; numbers
        // are tolerated because env-var config parsing coerces numeric strings.
        ...
        const requestOptions = {
            ...
            // schedule an archive), and got would not retry a POST by
            // default anyway.
            retry: {
                limit: 0
            }
