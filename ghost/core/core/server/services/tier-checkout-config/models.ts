 ...
 */
export const ShippingAddressCollection = z.object({
    /** Where it is kept. Null while nothing is bound to it. */
...
export type ShippingAddressCollection = z.infer<typeof ShippingAddressCollection>;
...
export const TierCheckoutConfig = z.object({
    ...
    shippingAddress: ShippingAddressCollection.nullable(),
...
export const StoredCollection = z.object({
    shippingAddress: z.object({allowedCountries: z.array(z.string())}).nullable(),
    taxNumber: z.boolean(),
    phone: z.boolean()
});
...
export const emptyStoredCheckout = (): StoredCheckout => ({
    customFields: [],
    collect: {shippingAddress: null, taxNumber: false, phone: false}
});
...
export const collectsSomething = (collect: StoredCollection): boolean =>
    collect.shippingAddress !== null || collect.taxNumber || collect.phone;
